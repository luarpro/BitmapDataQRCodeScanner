...
:: Android packaging
set AND_CERT_NAME="BitmapDataQRCodeScanner"
set AND_CERT_PASS=luar
set AND_CERT_FILE=cert\BitmapDataQRCodeScanner_play.p12
...
set APP_ID=air.BitmapDataQRCodeScanner

:: Output packages
set DIST_PATH=dist
set DIST_NAME=BitmapDataQRCodeScanner
